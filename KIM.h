...
#if defined(ESP32_POP_UP) //
#define ON_OFF_KIM_PIN 	D4
#define RX_KIM 			16
#define TX_KIM 			17
#define softSerial 		false
#elif defined(ESP8266)				//< WeMos D1
#define ON_OFF_KIM_PIN 	D4
#define RX_KIM 			16
#define TX_KIM 			17
...
#else								// POP-UP BUOY System defined as 'else'

#define ON_OFF_KIM_PIN 	12  // This pin was changed to avoid collision with GPS module
#define RX_KIM 			16
#define TX_KIM 			17
#define softSerial 		false
#define KIM_ENV "Undefined"
#endif
...
// -------------------------------------------------------------------------- //
    ...
    const char AT_AFMT[8] 		= {'A','T','+','A','F','M','T','='}; //!< "AT+AFMT="
		const char AT_SAVE_CFG[13] 		= {'A','T','+','S','A','V','E','_','C','F','G','\r','\0'}; //!< "AT+SAVE_CFG"
 ...
 */
    ...
    RetStatusKIMTypeDef set_AFMT(char AFMT[], uint8_t len);
 /** @} */
		
		RetStatusKIMTypeDef send_data(char data[], uint8_t len);
    RetStatusKIMTypeDef save_CFG();
