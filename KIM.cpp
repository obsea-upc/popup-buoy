...
RetStatusKIMTypeDef KIM::send_ATCommand() {
  ...
  for (int i = 0; i < 10; i++) {
    ...
    if ((response[0] != '\0') && (response[1] == 'K' /*OK*/ 
    || response[1] == 'I' /*+ID*/ || response[1] == 'S' /*+SN*/ 
    || response[1] == 'F' /*+FW*/ || response[1] == 'B' /*+BAND*/ 
    || response[1] == 'F' /*+FRQ*/ || response[1] == 'P' /*+PWR*/ 
    || OKCheck == true)) {
      return OK_KIM;
...
// -------------------------------------------------------------------------- //
//! Get the AFMT message format of the KIM1 module (seconds).
// -------------------------------------------------------------------------- //
...
// -------------------------------------------------------------------------- //
//! Set the AFMT message format of the KIM1 module.
// -------------------------------------------------------------------------- //

RetStatusKIMTypeDef KIM::set_AFMT(char AFMT[], uint8_t len) {
  for (uint8_t i = 0; i < 8; i++)
    command[i] = AT_AFMT[i];
...
RetStatusKIMTypeDef KIM::save_CFG() {
  for (uint8_t i = 0; i < 13; i++)
    command[i] = AT_SAVE_CFG[i];
